...
else if(exam_type==="End Sem Exam")
{
    ...
    $('#exam').click(function(){
      ...
      console.log('Department selected:', d);
      $('#d').val(d);
               $.post('sub.php',{dep:d},function(dta){
                    console.log('Subjects loaded:', dta);
                    $('#sub').html(dta);
    ...
    $('#ques').click(function(){
        ...
        console.log('Generating paper with:', {exam, semester, subject, dept});
        ...
        $.post('fetch_ques.php',{ex:exam,sem:semester,sub:subject,dep:dept},function(data){
                ...
                console.error('Failed to fetch questions:', status, error, xhr.responseText);
