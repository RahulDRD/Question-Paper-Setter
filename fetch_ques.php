<?php
        ...
        $unit54o=array();
         ...
         $q1="select * from $dep where unit=1 AND semester=$sem AND subject='$sub' AND marks=8";
            $ch1=mysqli_query($con,$q1);
            $q2="select * from $dep where unit=2 AND semester=$sem AND subject='$sub' AND marks=8";
            $ch2=mysqli_query($con,$q2);
           
         $q3="select * from $dep where unit=3 AND semester=$sem AND subject='$sub' AND marks=8";
         $ch3=mysqli_query($con,$q3);
         $q4="select * from $dep where unit=4 AND semester=$sem AND subject='$sub' AND marks=8";
         $ch4=mysqli_query($con,$q4);
         $q5="select * from $dep where unit=5 AND semester=$sem AND subject='$sub' AND marks=8";
         $ch5=mysqli_query($con,$q5);

        //  4 marks question

        $q6="select * from $dep where unit=1 AND semester=$sem AND subject='$sub' AND marks=4";
        $ch6=mysqli_query($con,$q6);
        $q7="select * from $dep where unit=2 AND semester=$sem AND subject='$sub' AND marks=4";
        $ch7=mysqli_query($con,$q7);
       
     $q8="select * from $dep where unit=3 AND semester=$sem AND subject='$sub' AND marks=4";
     $ch8=mysqli_query($con,$q8);
     $q9="select * from $dep where unit=4 AND semester=$sem AND subject='$sub' AND marks=4";
     $ch9=mysqli_query($con,$q9);
     $q10="select * from $dep where unit=5 AND semester=$sem AND subject='$sub' AND marks=4";
