  ...
  <head>
    ...
    <style>
      ...
      :root {
        ...
        --secondary-gradient: linear-gradient(135deg, #9F92C7 0%, #D4BAD3 100%);
          ...
          <tr>
            ...
            <td>
              <button class="btn btn-primary" id="ques">
                <i class="fas fa-tasks"></i> Generate Questions
              </button>
            </td>
          </tr>
        </table>
      ...
      <script>
        ...
        loadDepartments();
          ...
          downloadBtn.addEventListener("click", function () {
            ...
            pdfMake.createPdf(docDefinition).download(`Question_Paper_${subject}_${date}.pdf`);
          });

          autoCreateBtn.addEventListener('click', function() {
            alert('Document creation functionality would be implemented here based on the selected options.');
            closeModal();
          });
