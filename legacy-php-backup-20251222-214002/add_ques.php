  ...
  <i class="fas fa-eye mr-2"></i> View Questions
    ...
    <script>
      $(document).ready(function(){
        ...
        // Load subjects when department changes (semester-independent)
        ...
        $('#add').click(function(){
          ...
          if (subject === "Select" || dept === "Select" || unit === "Select" || marks === "Select" || ques === "") {
            $.toast({
          ...
          $.post('add.php', {sub: subject, dep: dept, uni: unit, que: ques, marks: marks}, function(data){
            $('#question').val("");
            $.toast({
        ...
        $('#addsub').click(function(){
          ...
          $.post('addsub.php', {dep: dept, sub: sub}, function(data){
            if (data === '1') {
              $("#subname").val("");
              $.toast({
                heading: 'Added Successfully',
              ...
              // Reload departments to reflect new subject
              loadDepartments();
            } else if (data === 'DUPLICATE') {
              $.toast({
                text: "Subject already exists for this department",
                heading: 'Duplicate',
                icon: 'error',
                showHideTransition: 'slide',
                allowToastClose: true,
        ...
        $('#vsub').click(function(){
          ...
          $.post('viewques.php', {dept: dept}, function(data){
            $('#subedit').html(data);
